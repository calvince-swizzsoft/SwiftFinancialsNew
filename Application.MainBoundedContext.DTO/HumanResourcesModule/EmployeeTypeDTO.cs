...
{
    public class EmployeeTypeDTO : BindingModelBase<EmployeeTypeDTO>
    {
        ...
        public string CategoryDescription
        {
            get
            {
                return Enum.IsDefined(typeof(EmployeeCategory), Category) ? EnumHelper.GetDescription((EmployeeCategory)Category) : string.Empty;
            }
        }
