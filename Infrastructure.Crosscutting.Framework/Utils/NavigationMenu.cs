    ...
    public class NavigationMenu
    {
        ...
        public List<NavigationMenu> GetMenus()
        {
            var menus = new List<NavigationMenu>()
            {
                ...
                new NavigationMenu{AreaCode = 0x00004E20, IsArea = false, Description = "Reports", Icon="fa fa-calculator", ControllerName="Report", ActionName="Index", AreaName = "Admin", Code = 0x00004E20 + 6},
                ...
                new NavigationMenu{AreaCode = 0x000059D8, IsArea = false, Description = "Cost Center", Icon="fa fa-settings", ControllerName="CostCenter", ActionName="Index", AreaName = "Accounts", Code = 0x000059D8 + 4},
                new NavigationMenu{AreaCode = 0x000059D8, IsArea = false, Description = "Credit Types", Icon="fa fa-usb", ControllerName="CreditType", ActionName="Index", AreaName = "Accounts", Code = 0x000059D8 + 5},
                new NavigationMenu{AreaCode = 0x000059D8, IsArea = false, Description = "Debit Types", Icon="fa fa-bars", ControllerName="DebitType", ActionName="Index", AreaName = "Accounts", Code = 0x000059D8 + 6},
