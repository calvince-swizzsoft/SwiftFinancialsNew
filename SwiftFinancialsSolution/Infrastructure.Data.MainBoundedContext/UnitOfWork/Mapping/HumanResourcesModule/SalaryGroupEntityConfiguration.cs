...
{
    class SalaryGroupEntityConfiguration : EntityTypeConfiguration<SalaryGroup>
    {
        public SalaryGroupEntityConfiguration()
        {
            HasKey(x => x.Id);
            ...
            ToTable(string.Format("{0}SalaryGroups", DefaultSettings.Instance.TablePrefix));
        }
    }
}
