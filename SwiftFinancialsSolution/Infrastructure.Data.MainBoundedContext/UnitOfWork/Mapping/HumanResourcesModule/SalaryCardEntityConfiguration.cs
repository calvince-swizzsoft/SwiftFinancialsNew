...
{
    class SalaryCardEntityConfiguration : EntityTypeConfiguration<SalaryCard>
    {
        public SalaryCardEntityConfiguration()
        {
            HasKey(x => x.Id);
            ...
            ToTable(string.Format("{0}SalaryCards", DefaultSettings.Instance.TablePrefix));
        }
    }
}
