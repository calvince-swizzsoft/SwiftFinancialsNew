...
{
    class DebitBatchEntityConfiguration : EntityTypeConfiguration<DebitBatch>
    {
        public DebitBatchEntityConfiguration()
        {
            HasKey(x => x.Id);
            ...
            ToTable(string.Format("{0}DebitBatches", DefaultSettings.Instance.TablePrefix));
        }
    }
}
