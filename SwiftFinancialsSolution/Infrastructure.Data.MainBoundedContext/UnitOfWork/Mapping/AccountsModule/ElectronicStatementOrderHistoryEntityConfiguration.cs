...
{
    class ElectronicStatementOrderHistoryEntityConfiguration : EntityTypeConfiguration<ElectronicStatementOrderHistory>
    {
        public ElectronicStatementOrderHistoryEntityConfiguration()
        {
            HasKey(x => x.Id);
            ...
            Property(x => x.Sender).HasMaxLength(256);

            Property(x => x.Remarks).HasMaxLength(256);

            ToTable(string.Format("{0}ElectronicStatementOrderHistories", DefaultSettings.Instance.TablePrefix));
        }
    }
}
