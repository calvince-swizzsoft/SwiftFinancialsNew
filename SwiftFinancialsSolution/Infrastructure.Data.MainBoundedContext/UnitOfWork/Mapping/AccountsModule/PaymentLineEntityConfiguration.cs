...
{
    class PaymentLineEntityConfiguration : EntityTypeConfiguration<PaymentLine>
    {

        PaymentLineEntityConfiguration()
        {
            ...
            ToTable(string.Format("{0}PaymentLine", DefaultSettings.Instance.TablePrefix));
