...
namespace SwiftFinancials.Web.Areas.Registry.Controllers
{
    public class StationLinkageController : MasterController
    {
        ...
        public async Task<JsonResult> Index(JQueryDataTablesModel jQueryDataTablesModel)
        {
            ...
            {
                pageCollectionInfo.PageCollection = pageCollectionInfo.PageCollection.OrderByDescending(station => station.CreatedDate).ToList();
        ...
        public async Task<ActionResult> Details(Guid id)
        {
            ...
            // Fetch the specific station by ID using the service
            var stationDTO = await _channelService.FindDirectorAsync(id, GetServiceHeader());

            // Check if the station was found
            if (stationDTO == null)
            {
                return HttpNotFound();
            }

            // Pass the station data to the Details view
        ...
        //    if (!stationDTO.HasErrors)
        //    {
        //        await _channelService.AddDirectorAsync(stationDTO, GetServiceHeader());
        ...
        //    else
        //    {
        //        var errorMessages = stationDTO.ErrorMessages;
