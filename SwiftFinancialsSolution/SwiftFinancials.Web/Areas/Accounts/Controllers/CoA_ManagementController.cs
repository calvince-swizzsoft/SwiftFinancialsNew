...
{
    public class CoA_ManagementController : MasterController
    {
        ...
        public async Task<ActionResult> Create(Guid? id)
        {
            ...
            ViewBag.ManagementActionSelectList = GetCustomerAccountManagementActionSelectList(string.Empty);
            ...
            if (customer != null)
            {
                ...
                customerAccountDTO.CustomerAccount = customer;
        ...
        {
            ViewBag.ManagementActionSelectList = GetCustomerAccountManagementActionSelectList(customerAccountDTO.CustomerAccountManagementAction.ToString());
            ...
            customerAccountDTO.TotalValue = 2;
