...
{
    public class AttachedLoanDTO : BindingModelBase<AttachedLoanDTO>
    {
        public AttachedLoanDTO()
        {
        ...
        public string LoanCasePaddedCaseNumber
        {
            get
            {
                return string.Format("{0}", LoanCaseCaseNumber).PadLeft(7, '0');
            }
        }
        ...
        [DataMember]
        [Display(Name = "Clearance Charges")]
        ...
        [DataMember]
        [Display(Name = "Section")]
        public string CustomerAccountTypeTargetProductProductSectionDescription
        {
            get
            {
                return Enum.IsDefined(typeof(LoanProductSection), CustomerAccountTypeTargetProductProductSection) ? EnumHelper.GetDescription((LoanProductSection)CustomerAccountTypeTargetProductProductSection) : string.Empty;
            }
        }

        [DataMember]
        [Display(Name = "Product Is Microcredit?")]
