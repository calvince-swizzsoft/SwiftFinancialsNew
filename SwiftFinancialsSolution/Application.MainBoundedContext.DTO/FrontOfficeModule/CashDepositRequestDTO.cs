...
{
    public class CashDepositRequestDTO : BindingModelBase<CashDepositRequestDTO>
    {
        ...
        public string StatusDescription
        {
            get
            {
                return Enum.IsDefined(typeof(CashDepositRequestAuthStatus), Status) ? EnumHelper.GetDescription((CashDepositRequestAuthStatus)Status) : string.Empty;
            }
        }
