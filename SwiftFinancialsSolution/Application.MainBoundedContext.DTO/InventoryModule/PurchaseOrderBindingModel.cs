...
{
    public class PurchaseOrderBindingModel : BindingModelBase<PurchaseOrderBindingModel>
    {
        public PurchaseOrderBindingModel()
        {
        ...
        public List<PurchaseOrderEntryBindingModel> PurchaseOrderEntries { get; set; }
    }
}
