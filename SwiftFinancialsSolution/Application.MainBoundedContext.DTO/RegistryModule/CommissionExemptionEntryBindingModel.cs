...
{
    public class CommissionExemptionEntryBindingModel : BindingModelBase<CommissionExemptionEntryBindingModel>
    {
        public CommissionExemptionEntryBindingModel()
        {
        ...
        [DataMember]
        [Display(Name = "Commission Exemption")]
        [ValidGuid]
        public Guid CommissionExemptionId { get; set; }

        [DataMember]
        [Display(Name = "Commission Exemption")]
        public string CommissionExemptionDescription { get; set; }
