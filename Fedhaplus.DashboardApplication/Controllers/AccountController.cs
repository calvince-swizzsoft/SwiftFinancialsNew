...
namespace Fedhaplus.DashboardApplication.Controllers
{
    ...
    public class AccountController : MasterController
    {
            ...
            IAuthenticationManager authenticationManager, ServiceHeader serviceHeader)
        {
            ...
            _provider = new DpapiDataProtectionProvider("Fedhaplus");
        ...
        public async Task<ActionResult> SendCode(SendCodeViewModel sendCodeViewModel)
        {
            using (_applicationUserManager)
            {
                ...
                */
                return null;// RedirectToAction("VerifyCode"/*, new { sendCodeViewModel.Provider, applicationUser.UserName*/, sendCodeViewModel.ReturnUrl });
            }
        }
