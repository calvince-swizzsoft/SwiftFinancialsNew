...
namespace Fedhaplus.DashboardApplication.Reports
{
    public partial class StockItem : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            RptDoc.Load("C:\\Program Files (x86)\\Inventory Master\\dashboard_client\\Reports\\StockItems.rpt");

            //Report pfd name    
            string fname = "StockItems.pdf";
