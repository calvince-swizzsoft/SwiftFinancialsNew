...
{
    public class RequisitionController : MasterController
    {
        ...
        // GET: Inventory/Requisition/Details/5
        public ActionResult Details(int id)
        {
            return View();
        }

        // GET: Inventory/Requisition/Create
        ...
        // POST: Inventory/Requisition/Create
        [HttpPost]
        ...
        // GET: Inventory/Requisition/Edit/5
        public ActionResult Edit(int id)
        {
            return View();
        }

        // POST: Inventory/Requisition/Edit/5
        [HttpPost]
        ...
        // GET: Inventory/Requisition/Delete/5
        public ActionResult Delete(int id)
        {
            return View();
        }

        // POST: Inventory/Requisition/Delete/5
        [HttpPost]
