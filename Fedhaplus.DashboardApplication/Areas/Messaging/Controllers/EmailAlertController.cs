...
namespace Fedhaplus.DashboardApplication.Areas.Messaging.Controllers
{
    ...
    public class EmailAlertController : MasterController
    {
        ...
        [HttpPost]
        public async Task<ActionResult> Create(EmailAlertBindingModel emailAlertBindingModel)
        {
            ...
            var emailAlertDTO = await _channelService.AddEmailAlertAsync(emailAlertBindingModel.MapTo<EmailAlertDTO>(), GetServiceHeader());
