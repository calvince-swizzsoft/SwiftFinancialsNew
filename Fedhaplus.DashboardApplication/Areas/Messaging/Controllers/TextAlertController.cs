...
namespace Fedhaplus.DashboardApplication.Areas.Messaging.Controllers
{
    public class TextAlertController : MasterController
    {
        ...
        [HttpPost]
        public async Task<ActionResult> Create(TextAlertBindingModel textAlertBindingModel)
        {
            ...
            var textAlertDTO = await _channelService.AddTextAlertAsync(textAlertBindingModel.MapTo<TextAlertDTO>(), GetServiceHeader());
