...
namespace SwiftFinancials.Web.Areas.Loaning.Controllers
{
    public class LoanGuarantorController : MasterController
    {
        ...
        public async Task<JsonResult> Index(JQueryDataTablesModel jQueryDataTablesModel)
        {
            ...
            var pageCollectionInfo = await _channelService.FindLoanCasesByLoanProductSectionAndFilterInPageAsync(int loanProductSection, int status, DateTime startDate, DateTime endDate, string text, int loanCaseFilter, int pageIndex, pageSize, includeBatchStatus, GetServiceHeader() );
