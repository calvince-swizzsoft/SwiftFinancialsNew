...
namespace SwiftFinancials.Web.Areas.Admin.Controllers
{
    public class ModuleController : MasterController
    {
        ...
        //{
        //    var navigationItemInRoleDTO = new ModuleNavigationItemInRoleDTO
        //    {
        //        ModuleNavigationItemId = NavigationItemToRoleViewModel.NavigationItemId,
        ...
        //    var result = await _channelService.AddModuleNavigationItemToRolesAsync(navigationItemInRoleDTO, GetServiceHeader());
        ...
        //{
        //    var result = await _channelService.RemoveModuleNavigationItemFromRolesAsync(NavigationItemToRoleViewModel.NavigationItemId, NavigationItemToRoleViewModel.RoleName, GetServiceHeader());
