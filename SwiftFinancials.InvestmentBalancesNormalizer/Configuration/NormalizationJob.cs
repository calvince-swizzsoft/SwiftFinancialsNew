...
{
    public class NormalizationJob : IJob
    {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
                ...
                if (investmentBalancesNormalizerConfigSection != null)
                {
                    foreach (var settingsItem in investmentBalancesNormalizerConfigSection.InvestmentBalancesNormalizerSettingsItems)
                    {
                        ...
                        if (investmentBalancesNormalizerSettingsElement != null && investmentBalancesNormalizerSettingsElement.Enabled == 1)
                        {
                            ...
                            await _channelService.NormalizeInvestmentBalancesAsync(investmentBalancesNormalizerSettingsElement.NormalizationSets, (int)QueuePriority.Normal, investmentBalancesNormalizerSettingsElement.EnforceCeiling == 1, serviceHeader);
                        }
                    }
                }
            }
            ...
            {
                _logger.LogError("VanguardFinancials.InvestmentBalancesNormalizer_NormalizationJob.Execute", ex);
            }
        }
