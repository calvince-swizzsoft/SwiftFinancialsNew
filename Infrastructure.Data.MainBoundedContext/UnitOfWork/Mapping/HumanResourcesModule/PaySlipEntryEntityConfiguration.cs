...
{
    class PaySlipEntryEntityConfiguration : EntityTypeConfiguration<PaySlipEntry>
    {
        public PaySlipEntryEntityConfiguration()
        {
            HasKey(x => x.Id);
            ...
            ToTable(string.Format("{0}PaySlipEntries", DefaultSettings.Instance.TablePrefix));
        }
    }
}
