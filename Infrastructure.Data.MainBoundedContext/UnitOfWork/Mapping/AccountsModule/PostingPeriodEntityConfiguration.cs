...
{
    class PostingPeriodEntityConfiguration : EntityTypeConfiguration<PostingPeriod>
    {
        public PostingPeriodEntityConfiguration()
        {
            HasKey(x => x.Id);
            ...
            ToTable(string.Format("{0}PostingPeriods", DefaultSettings.Instance.TablePrefix));
        }
    }
}
