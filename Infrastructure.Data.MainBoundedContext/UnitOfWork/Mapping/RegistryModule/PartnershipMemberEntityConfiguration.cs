...
{
    class PartnershipMemberEntityConfiguration : EntityTypeConfiguration<PartnershipMember>
    {
        public PartnershipMemberEntityConfiguration()
        {
            HasKey(x => x.Id);
            ...
            Property(x => x.PayrollNumbers).HasMaxLength(256);
            ...
            ToTable(string.Format("{0}PartnershipMembers", DefaultSettings.Instance.TablePrefix));
        }
    }
}
