...
{
    class StationEntityConfiguration : EntityTypeConfiguration<Station>
    {
        public StationEntityConfiguration()
        {
            HasKey(x => x.Id);
            ...
            ToTable(string.Format("{0}Stations", DefaultSettings.Instance.TablePrefix));
        }
    }
}
