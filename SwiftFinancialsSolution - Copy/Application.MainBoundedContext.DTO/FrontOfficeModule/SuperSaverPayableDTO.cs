...
{
    public class SuperSaverPayableDTO : BindingModelBase<SuperSaverPayableDTO>
    {
        public SuperSaverPayableDTO()
        {
        ...
        public decimal CustomerAccountAvailableBalance { get; set; }
        ...
        public string StatusDescription
        {
            get
            {
                return Enum.IsDefined(typeof(SuperSaverPayableStatus), Status) ? EnumHelper.GetDescription((SuperSaverPayableStatus)Status) : string.Empty;
            }
        }
