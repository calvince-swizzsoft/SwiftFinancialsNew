...
{
    public class CustomerAccountCarryForwardInstallmentDTO : BindingModelBase<CustomerAccountCarryForwardInstallmentDTO>
    {
        public CustomerAccountCarryForwardInstallmentDTO()
        {
