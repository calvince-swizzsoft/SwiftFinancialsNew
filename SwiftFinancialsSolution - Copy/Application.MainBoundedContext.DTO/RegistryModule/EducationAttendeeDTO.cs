...
{
    public class EducationAttendeeDTO : BindingModelBase<EducationAttendeeDTO>
    {
        public EducationAttendeeDTO()
        {
        ...
        [DataMember]
        [Display(Name = "Education Register")]
        [ValidGuid]
        public Guid EducationRegisterId { get; set; }

        [DataMember]
        [Display(Name = "Posting Period")]
        public Guid EducationRegisterPostingPeriodId { get; set; }

        [DataMember]
        [Display(Name = "Posting Period")]
        public string EducationRegisterPostingPeriodDescription { get; set; }
