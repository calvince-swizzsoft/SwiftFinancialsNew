...
{
    class WorkflowItemEntityConfiguration : EntityTypeConfiguration<WorkflowItem>
    {
        public WorkflowItemEntityConfiguration()
        {
            HasKey(x => x.Id);
            ...
            ToTable(string.Format("{0}WorkflowItems", DefaultSettings.Instance.TablePrefix));
        }
    }
}
