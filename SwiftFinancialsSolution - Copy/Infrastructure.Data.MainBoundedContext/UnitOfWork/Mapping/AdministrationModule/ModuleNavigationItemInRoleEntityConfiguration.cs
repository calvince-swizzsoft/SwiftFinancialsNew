...
{
    class ModuleNavigationItemInRoleEntityConfiguration : EntityTypeConfiguration<ModuleNavigationItemInRole>
    {
        public ModuleNavigationItemInRoleEntityConfiguration()
        {
            ...
            ToTable(string.Format("{0}ModuleNavigationItemsInRoles", DefaultSettings.Instance.TablePrefix));
        }
    }
}
