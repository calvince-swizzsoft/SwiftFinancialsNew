...
{
    class InterAccountTransferBatchEntityConfiguration : EntityTypeConfiguration<InterAccountTransferBatch>
    {
        public InterAccountTransferBatchEntityConfiguration()
        {
            HasKey(x => x.Id);
            ...
            ToTable(string.Format("{0}InterAccountTransferBatches", DefaultSettings.Instance.TablePrefix));
        }
    }
}
