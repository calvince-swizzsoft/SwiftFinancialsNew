...
{
    class SalesInvoiceEntityConfiguration : EntityTypeConfiguration<SalesInvoice>
    {
        public SalesInvoiceEntityConfiguration()
        {
            ...
            Property(t => t.CreatedDate).HasColumnAnnotation(IndexAnnotation.AnnotationName, new IndexAnnotation(new IndexAttribute("IX_SalesInvoice_CreatedDate")));

            ToTable(string.Format("{0}SalesInvoices", DefaultSettings.Instance.TablePrefix));
