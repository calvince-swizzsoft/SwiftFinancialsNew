...
{
    class JournalReversalBatchEntityConfiguration : EntityTypeConfiguration<JournalReversalBatch>
    {
        public JournalReversalBatchEntityConfiguration()
        {
            HasKey(x => x.Id);
            ...
            ToTable(string.Format("{0}JournalReversalBatches", DefaultSettings.Instance.TablePrefix));
        }
    }
}
