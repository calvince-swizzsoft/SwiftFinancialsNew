...
{
    class InvestmentProductEntityConfiguration : EntityTypeConfiguration<InvestmentProduct>
    {
        public InvestmentProductEntityConfiguration()
        {
            HasKey(x => x.Id);
            ...
            ToTable(string.Format("{0}InvestmentProducts", DefaultSettings.Instance.TablePrefix));
        }
    }
}
