...
{
    class BankReconciliationPeriodEntityConfiguration : EntityTypeConfiguration<BankReconciliationPeriod>
    {
        public BankReconciliationPeriodEntityConfiguration()
        {
            HasKey(x => x.Id);
            ...
            ToTable(string.Format("{0}BankReconciliationPeriods", DefaultSettings.Instance.TablePrefix));
        }
    }
}
