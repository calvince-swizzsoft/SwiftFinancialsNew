...
{
    class GeneralLedgerEntityConfiguration : EntityTypeConfiguration<GeneralLedger>
    {
        public GeneralLedgerEntityConfiguration()
        {
            HasKey(x => x.Id);
            ...
            ToTable(string.Format("{0}GeneralLedgers", DefaultSettings.Instance.TablePrefix));
        }
    }
}
