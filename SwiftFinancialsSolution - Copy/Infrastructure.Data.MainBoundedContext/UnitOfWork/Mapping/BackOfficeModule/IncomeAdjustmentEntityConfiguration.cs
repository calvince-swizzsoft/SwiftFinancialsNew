...
{
    class IncomeAdjustmentEntityConfiguration : EntityTypeConfiguration<IncomeAdjustment>
    {
        public IncomeAdjustmentEntityConfiguration()
        {
            HasKey(x => x.Id);
            ...
            ToTable(string.Format("{0}IncomeAdjustments", DefaultSettings.Instance.TablePrefix));
        }
    }
}
