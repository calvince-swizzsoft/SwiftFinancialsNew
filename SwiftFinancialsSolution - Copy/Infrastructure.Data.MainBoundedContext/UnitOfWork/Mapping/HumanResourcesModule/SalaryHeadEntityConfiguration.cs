...
{
    class SalaryHeadEntityConfiguration : EntityTypeConfiguration<SalaryHead>
    {
        public SalaryHeadEntityConfiguration()
        {
            HasKey(x => x.Id);
            ...
            ToTable(string.Format("{0}SalaryHeads", DefaultSettings.Instance.TablePrefix));
        }
    }
}
