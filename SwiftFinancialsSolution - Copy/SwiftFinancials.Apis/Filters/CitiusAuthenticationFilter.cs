...
namespace SwiftFinancials.Apis.Filters
{
    ...
    public class CitiusAuthenticationFilter : AuthorizationFilterAttribute
    {
        bool Active = true;
        ...
        public CitiusAuthenticationFilter()
        {
            ...
            if (webApiConfigSection != null)
            {
                ...
                foreach (var settingsItem in webApiConfigSection.WebApiSettingsItems)
                {
                    ...
                    {
                        ApiUserName = webApiSettingsElement.CitiusApiUsername;

                        ApiPassword = webApiSettingsElement.CitiusApiPassword;
                    }
                }
            }
        }
        ...
        public CitiusAuthenticationFilter(bool active)
            : this()
        {
            Active = active;
        }
        ...
        /// </summary>
        /// <param name="actionContext"></param>
        protected virtual CitiusAuthenticationIdentity ParseAuthorizationHeader(HttpActionContext actionContext)
        {
            ...
            return new CitiusAuthenticationIdentity(username, password);
        }
    ...
    public class CitiusAuthenticationIdentity : GenericIdentity
    {
        public CitiusAuthenticationIdentity(string name, string password)
            : base(name, "Basic")
        {
